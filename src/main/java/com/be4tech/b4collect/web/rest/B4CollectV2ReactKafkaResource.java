...
@RestController
@RequestMapping("/api/b-4-collect-v-2-react-kafka")
public class B4CollectV2ReactKafkaResource {

    private final Logger log = LoggerFactory.getLogger(B4CollectV2ReactKafkaResource.class);
    ...
    public B4CollectV2ReactKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
